...
# %IncMSE : the increase in mean squared error, where the error of the model prediction is increased by randomly replacing the value of each predictor variable if it's more important

# %IncNodePurity : measure of how much the homogeneity of groups changes when a variable is randomly permuted. This uses the Gini coefficient to calculate the decrease in purity if a variable has no information
```
